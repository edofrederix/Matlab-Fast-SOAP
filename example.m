...
data =  ...
    struct('val', struct( ...
        ...
        'spatialInterpolation', struct( ...
            'name', 'spatialInterpolation', ...
            'val', spatialInterpolation, ...
            'type', '{http://turbulence.pha.jhu.edu/}SpatialInterpolation'), ...
        'temporalInterpolation', struct( ...
            'name', 'temporalInterpolation', ...
            'val', temporalInterpolation, ...
            'type', '{http://turbulence.pha.jhu.edu/}TemporalInterpolation'), ...
        'points', struct( ...
            'name', 'points', ...
            'val', struct( ...
                'x', struct( ...
